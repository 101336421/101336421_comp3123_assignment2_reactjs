...
export default class EmployeeList extends Component {
    ...
    constructor(props) {
        ...
        getEmployeeDataByID = (id) => {
            axios.get(`hhttps://assignment02-101336421-backend.herokuapp.com/api/emp/employees/${id}`)
            .then(res =>{
        ...
        deleteEmployeeDataByID = (id) => {
            axios.delete(`https://assignment02-101336421-backend.herokuapp.com/api/emp/employees/${id}`)
            .then(res =>  { 
